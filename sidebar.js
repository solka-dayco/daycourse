    ...
    <div class="sidebar-inner">
      ...
      <nav class="sidebar-nav">
        <a href="main.html" class="sidebar-nav-item ${isCurrentPage('main') ? 'active' : ''}">
          <span class="sidebar-nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></span>
          <span>홈</span>
        </a>
        ${session ? `
          <a href="bookmarks.html" class="sidebar-nav-item ${isCurrentPage('bookmarks') ? 'active' : ''}">
            <span class="sidebar-nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg></span>
            <span>북마크</span>
          </a>
          <a href="notifications.html" class="sidebar-nav-item ${isCurrentPage('notifications') ? 'active' : ''}">
            <span class="sidebar-nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg></span>
            <span>알림</span>
            ${unreadBadge}
          </a>
        ` : ''}
